        ...
        <div class="modal-body">
            <form id="form1"  method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" name="editorial" id="editorial" placeholder="Ingrese Texto" required="true">
                     <input type="hidden" class="form-control" name="id_editorial" id="id_editorial" />
                </div>
                <div class="checkbox">
                    <label>
